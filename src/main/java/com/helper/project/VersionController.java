...
public class VersionController {
	...
	public List<VersionDto>  generateTomcatVersions() {
		...
		version10.setUrl("https://dlcdn.apache.org/tomcat/tomcat-10/v10.0.12/bin/apache-tomcat-10.0.12.tar.gz");
	...
	public List<VersionDto> generateJavaVersions()
	{
		...
		VersionDto java16=new VersionDto();
		java16.setJavaVersion("Java16");
		String java16Command="sudo apt-get update -y;sudo apt-get install openjdk-16-jdk -y;";
		java16Command+="sudo update-java-alternatives -s $(sudo update-java-alternatives -l | grep 16 | cut -d ' ' -f1) || echo '.'";;
		java16.setJavaCommand(java16Command);
		
		javaVersions.add(java17);
		javaVersions.add(java16);
